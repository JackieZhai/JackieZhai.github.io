...
description: 'We propose OrgMIM, a dual-branch MIM framework with complementary masking strategies to capture critical subcellular semantics and learn organelle-specific representations from EM data.'
authors: [yanchao, hao]
date: 2026-02-24 00:00:00 +0800
categories: [Journal, IEEE TMI 2026]
tags: [organelle, foundation model, pretraining, vEM]
math: true
pin: true
---
...
*Key Laboratory of Brain Cognition and Brain-inspired Intelligence Technology, Institute of Automation, Chinese Academic of Sciences* <br>
...
> Zhang Y, Zhai H, Guo J, Li Z, Liu J, Han H (2026). Masked Image Modeling for Generalizable Organelle Segmentation in Volume EM. *IEEE Transactions on Medical Imaging*, early access. [https://doi.org/10.1109/TMI.2026.3667612](https://doi.org/10.1109/TMI.2026.3667612).
>
