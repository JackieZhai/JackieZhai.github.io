...
- Ph.D., Key Laboratory of Brain Cognition and Brain-inspired Intelligence Technology, Institute of Automation, Chinese Academic of Sciences ([CASIA](https://english.ia.cas.cn/)), in 2025.
...
3. **Zhang Y**, **Zhai H**, Guo J, Li Z, Liu J, Han H (2026). [Masked Image Modeling for Generalizable Organelle Segmentation in Volume EM](https://jackiezhai.github.io/posts/OrgMIM/). ***IEEE Transactions on Medical Imaging***, [early access](https://doi.org/10.1109/TMI.2026.3667612).
4. **Zhang Y**, **Zhai H**, Guo J, Liu J, Xie Q, Han H (2025). [A Distribution-aware Semi-Supervised Pipeline for Cost-effective Neuron Segmentation in Volume Electron Microscopy](https://jackiezhai.github.io/posts/SL-SSNS/). ***iScience***, [114507](https://doi.org/10.1016/j.isci.2025.114507).
5. **Yan H**, **Zhai H**, Guo J, Li L, Zhong Y, Du X, Han H (2024). [NeuroLink: Bridging Weak Signals in Neuronal Imaging with Morphology Learning](https://jackiezhai.github.io/posts/NeuroLink/). In ***Proceedings of Medical Image Computing and Computer Assisted Intervention (MICCAI)***, [467-477](https://doi.org/10.1007/978-3-031-72111-3_44).
6. **Zhai H**, Liu J, Hong B, Liu J, Xie Q, Han H (2024). [Intra-and Inter-Cellular Awareness for 3D Neuron Tracking and Segmentation in Large-Scale Connectomics](https://jackiezhai.github.io/posts/II-CATS/). In ***Proceedings of Machine Learning Research***, [*227*, 1691–1712](https://proceedings.mlr.press/v227/zhai24a.html).
7. **Zhai H**, **Yan H**, Zhou J, Liu J, Xie Q, Shen L, Chen X, Han H (2025). [InteBOMB: Integrating generic object tracking and segmentation with pose estimation for animal behavior analysis](https://jackiezhai.github.io/posts/InteBOMB/). ***Zoological Research***, [*46*(2): 355-369](https://doi.org/10.24272/j.issn.2095-8137.2024.268).
8. **Chen X**, **Zhai H**, Liu D, Li W, Ding C, Xie Q, Han H (2021). [SiamBOMB: a real-time AI-based system for home-cage animal tracking, segmentation and behavioral analysis](https://jackiezhai.github.io/posts/SiamBOMB/). In ***Proceedings of  International Joint Conference on Artificial Intelligence (IJCAI),*** [5300-5302](https://www.ijcai.org/proceedings/2020/776).

**Contributing Author**

* **Li FN**, **Liu JZ**, **Shi C**, **Yuan JB**, **Lv YN**, **Liu J**, **Zhang LN**, **Li LL**, **Shen LJ**, **Chen X**, Zhai H, Zhang YC, Tao RK, Hu HY, Zhou FX, Xin T, Chen BH, Chen HR, Chang S, Ma HT, Yan HY, Zu JL, Guo JY, Fang ZH, Dong XH, Lin LM, Zhao XH, Qian CY, Wang YS, Jin SR, Zhang CM, Xiang PS, Yang YX, Qian Y, Gong YC, Du XF, Xie QW, Han H, Du JL (2025). Multiplexed neuromodulatory-type-annotated whole-brain EM-reconstruction of larval zebrafish. ***bioRxiv***, [2025.06.12.659365](https://doi.org/10.1101/2025.06.12.659365), submitted.
...
* **Guo J**, **Wang Z**, Zhai H, Liu J, Zhang Y, Han H (2024). Re-isotropic Segmentation for Subcellular Ultrastructure in Anisotropic EM Images. ***IEEE Transactions on Medical Imaging***, [*44*(4): 1624-1635](https://doi.org/10.1109/TMI.2024.3511599).
